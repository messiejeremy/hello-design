    ...
    <FormField
      ...
      render={({ field }) => (
        <FormItem className="col-span-12">
          <FormLabel className="font-[500] text-[14px] tracking-[-0.42px] leading-5 text-slate-600" htmlFor="profilePicture">
            Profile picture
          </FormLabel>
          <div className="flex flex-1 gap-4 items-center">
            ...
            <Input ref={inputRef} id="profilePicture" type="file" accept=".png, .jpg" className="hidden" onChange={handleImageChange} />
